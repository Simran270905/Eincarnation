...
export default function ContactPage() {
  const googleMapsUrl =
    "https://www.google.com/maps/search/?api=1&query=E-Incarnation+Recycling+Ghatkopar";

  const mapEmbedSrc =
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3770.211145136894!2d72.90566367583688!3d19.09840485139446!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c7cb33333333%3A0x7b5b5b5b5b5b5b5b!2sBhaveshwar%20Arcade!5e0!3m2!1sen!2sin!4v1715600000000!5m2!1sen!2sin";

  return (
    <section className="w-full bg-[#f1efe0] min-h-screen font-sans text-[#333] flex flex-col">
      {/* ================= HERO SECTION ================= */}
      <div className="relative h-[36vh] sm:h-[44vh] w-full overflow-hidden rounded-b-[30px] sm:rounded-b-[40px] shadow-lg">
        {/* Map */}
        <iframe
          title="map"
        ...
        {/* Text over map */}
        <div className="relative z-20 max-w-7xl mx-auto h-full flex flex-col justify-end pb-8 sm:pb-14 px-4 sm:px-12">
        ...
        <div className="lg:col-span-7 xl:col-span-8 order-2 lg:order-1 flex flex-col justify-between">
          ...
          >
            <input
              type="text"
              placeholder="Name"
              className="w-full rounded-full bg-white px-6 py-4 text-sm shadow-sm outline-none"
            />
            <input
              type="text"
            ...
            <textarea
              placeholder="Message"
              rows={5}
              className="md:col-span-2 w-full rounded-[25px] bg-white px-6 py-4 text-sm shadow-sm outline-none resize-none"
            />
          ...
          <div className="mt-6 flex justify-center md:justify-start">
            <img
              src={robot}
              alt="Robot character"
              className="w-24 sm:w-32 md:w-48 object-contain opacity-90"
            />
          </div>
        </div>
