...
const Footer = () => {
  return (
    <footer className="w-full bg-[#101E3E] text-white py-16 px-8 md:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
              <span className="text-[8px] text-black font-bold uppercase">Logo</span>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4 items-center">
            ...
            <p className="text-sm text-gray-300">info@e-incarnation.com</p>
          </div>
        </div>
...
const SocialIcon = ({ icon }) => (
  <div className="w-9 h-9 bg-white/10 rounded-full flex items-center justify-center cursor-pointer hover:bg-white/20 transition-all">
    {icon}
  </div>
);
